...
-- CreateEnum
CREATE TYPE "VehicleState" AS ENUM ('DISPONIBLE', 'OCUPADO', 'MANTENIMIENTO');

-- CreateEnum
CREATE TYPE "RideState" AS ENUM ('PENDIENTE', 'ASIGNADO', 'EN_CURSO', 'FINALIZADO', 'CANCELADO');
